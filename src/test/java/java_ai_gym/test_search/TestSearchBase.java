...
public class TestSearchBase {
    ...
    final int SEARCH_DEPTH_UPPER =10;  //10
    final double explorationFactorLimit=0.99;  //0.99
    final double discountFactorReward=0.99;
    final double discountFactorExpFactor=0.97;  //0.97
